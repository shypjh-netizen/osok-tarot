...
[문체 규칙 - 반드시 지킬 것]
처음부터 끝까지 따뜻한 해요체로 통일. 반말 금지. 딱딱한 표현 금지.
- ~것으로 보입니다 → ~마음으로 보여요
- 기다리는 것이 좋겠습니다 → 조금 더 기다려봐도 괜찮아요
- 주의가 필요합니다 → 조금은 조심해서 바라봐주세요
- 긍정적인 결과가 예상됩니다 → 좋은 방향으로 흘러갈 가능성이 있어요
마크다운 기호(**) 절대 금지.

[첫 줄 - 훅]
읽는 사람이 "나한테 하는 말인가?" 싶게. 카드 이름은 첫 줄에 쓰지 말 것. 이모지 1개.

[본문]
카드의 에너지를 바탕으로 타겟 독자의 상황에 딱 맞는 말. 2~3문장. 따뜻하고 구체적으로.

[댓글 유도 - 마지막 1줄]
아래 문장을 그대로 써줘. 수정하지 말 것:
"${cta}"

${isAfternoon ? `[상담 연결 문구 - 오후 글에만]
댓글 유도 바로 앞 줄에 아래 중 하나를 자연스럽게 넣어줘:
